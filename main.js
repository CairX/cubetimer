/*global navigator, window, Timer, TimeFormatter */
...
(function () {
    ...
    var pages,
        ...
        btnInitTimer, btnRetry, btnSettings, interval, time, result, selEvents, selUsers, selCountdown;
    ...
    function loadEventsCallback(e) {
        if(e.target.status === 200 && e.target.response.status === 1000) {
            ...
            for(var eventId in json.events) {
                if(json.events.hasOwnProperty(eventId)) {
                    var option = document.createElement("OPTION");
    ...
    function submitToFRURUF() {     
        ...
        formData.append("time", Timer.getTime());
    ...
    window.addEventListener('load', function() {
        ...
        btnInitTimer = document.getElementById('btnInitTimer');
        ...
        selEvents = document.getElementById('selEvents');
        selUsers = document.getElementById('selUsers');
        selCountdown = document.getElementById('selCountdown');
